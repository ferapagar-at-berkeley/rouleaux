...
class PlaneProjection2D(Processor):
    def __init__(self, A: torch.Tensor, B: torch.Tensor, C: torch.Tensor, name = "plane_projection_2d", **kwargs):
...
class PlaneProjection(Processor):
    def __init__(self, A: torch.Tensor, B: torch.Tensor, C: torch.Tensor, name = "plane_projection", **kwargs):
...
class PlaneMask(Processor):
    def __init__(self, A: torch.Tensor, B: torch.Tensor, C: torch.Tensor, 
                 v_O: torch.Tensor, t_Ap: float, t_Bp: float, t_Cp: float, name="plane_mask", **kwargs):
        ...
        def to_rgb(t):
            return [int(x) for x in t.cpu().numpy()]
...
class TriangleProjection2D(Processor):
    def __init__(self, A: torch.Tensor, B: torch.Tensor, C: torch.Tensor, name = "triangle_projection_2d", **kwargs):
        super().__init__(A=A, B=B, C=C, name=name, fmt="uv", **kwargs)
        self.A = A
        self.B = B
        self.C = C
...
class TriangleProjection(Processor):
    def __init__(self, A: torch.Tensor, B: torch.Tensor, C: torch.Tensor, name = "triangle_projection", **kwargs):
        super().__init__(A=A, B=B, C=C, name=name, fmt="rgb", **kwargs)
        self.A = A
        self.B = B
        self.C = C
...
class TriangleMask(Processor):
    def __init__(self, A: torch.Tensor, B: torch.Tensor, C: torch.Tensor, 
                 v_O: torch.Tensor, t_Ap: float, t_Bp: float, t_Cp: float, name="triangle_mask", **kwargs):
        super().__init__(A=A, B=B, C=C, v_O=v_O, t_Ap=t_Ap, t_Bp=t_Bp, t_Cp=t_Cp, name=name, fmt="categorical", **kwargs)
        self.A = A
        self.B = B
        self.C = C
